...
main (int argc, char *argv[])
{
	...
	Simulator::Schedule (Seconds(2), &OFSwitch13WifiController::ChannelQualityReportStrategy,
						 wifiControl);
	Simulator::Schedule(Seconds(3), &OFSwitch13WifiController::ConfigAssocStrategy,
					   wifiControl);
	Simulator::Schedule (Seconds(6), &OFSwitch13WifiController::ConfigChannelStrategyInterval,
						 wifiControl, 3);
