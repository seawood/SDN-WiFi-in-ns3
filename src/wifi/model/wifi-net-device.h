...
private:
  ...
  void AddEthernetHeaderTrailer (Ptr<Packet>, Mac48Address src, Mac48Address dest, uint16_t protocolNumber);
  ...
  NetDevice::PromiscReceiveCallback m_openFlowRxCallback; //!openflow callback
